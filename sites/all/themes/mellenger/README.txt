...
2. Put the bootstrap folder inside the mellenger theme folder in [path the themes]/mellenger/bootstrap/ or use the Twitter Bootstrap UI (http://drupal.org/project/twitter_bootstrap_ui) module with the Libraries API.
3. Put any plugin files into [path the themes]/mellenger/bootstrap/js/
